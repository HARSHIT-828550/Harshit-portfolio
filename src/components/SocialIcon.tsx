...
/**
 * Inline brand/social SVG icons (GitHub, LinkedIn, Email) rendered with
 * `currentColor` so they inherit the surrounding text colour. Used instead of
 * emoji for a cleaner, more professional look.
 */
...
const SocialIcon: React.FC<SocialIconProps> = ({ name, size = 22 }) => {
  ...
  // Email / fallback envelope (lucide-style stroked icon)
  return (
    <svg
      {...common}
      fill="none"
